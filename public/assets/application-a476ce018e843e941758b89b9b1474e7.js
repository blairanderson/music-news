...
(function() {
  ...
  MusicNews.Views.SongPartial = (function(_super) {
    ...
    SongPartial.prototype.facebook = function() {
      return this.openWindow(this.submission.get('share'), "FACEBOOP DAT");
    };

    SongPartial.prototype.twitter = function() {
      return this.openWindow(this.submission.get('tweet'), "TWOOT dat");
    };

    SongPartial.prototype.openWindow = function(url, name) {
